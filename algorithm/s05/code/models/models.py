...
def create_model(model_config: namedtuple, classes: List[str], meta_file: str) :
    """
    ...
    model.load_state_dict(torch.load(f'../weights/{platform}.pt'))
    model.eval()
    return model


def select_model(classes: List[str], meta_file: str):
    """
